...
# Rscript easyDifferentialGeneCoexpressionInputParameters.r "PROBESETS" "../data/dc_probeset_list03.csv" "GSE16237" "outcome of the patient:ch1" "Died of disease" "Alive"
