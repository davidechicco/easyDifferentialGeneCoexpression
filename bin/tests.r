...
# easyDifferentialGeneCoexpression(probesetList,  "GSE16237", "outcome of the patient:ch1", "Died of disease", "Alive", verboseFlag)
...
# easyDifferentialGeneCoexpression(probesetList,  "GSE30201", "source_name_ch1", "Patient", "Normal", verboseFlag)


easyDifferentialGeneCoexpression(probesetList,  "GSE3268", "description", "Normal", "Tumor", verboseFlag)
